...
// CliGreen 绿色字体，modifier里，第一个控制闪烁，第二个控制下划线
func CliGreen(str string, modifier ...interface{}) string {
	return CliColorRender(str, 32, 0, modifier...)
}

// CliLightGreen 淡绿
func CliLightGreen(str string, modifier ...interface{}) string {
	return CliColorRender(str, 32, 1, modifier...)
}

// CliCyan 青色/蓝绿色
func CliCyan(str string, modifier ...interface{}) string {
	return CliColorRender(str, 36, 0, modifier...)
}

// CliLightCyan 淡青色
func CliLightCyan(str string, modifier ...interface{}) string {
	return CliColorRender(str, 36, 1, modifier...)
}
// CliRed 红字体
func CliRed(str string, modifier ...interface{}) string {
	return CliColorRender(str, 31, 0, modifier...)
}

// CliLightRed 淡红色
func CliLightRed(str string, modifier ...interface{}) string {
	return CliColorRender(str, 31, 1, modifier...)
}

// CliYellow 黄色字体
func CliYellow(str string, modifier ...interface{}) string {
	return CliColorRender(str, 33, 0, modifier...)
}

// CliBlack 黑色
func CliBlack(str string, modifier ...interface{}) string {
	return CliColorRender(str, 30, 0, modifier...)
}

// CliDarkGray 深灰色
func CliDarkGray(str string, modifier ...interface{}) string {
	return CliColorRender(str, 30, 1, modifier...)
}

// CliLightGray 浅灰色
func CliLightGray(str string, modifier ...interface{}) string {
	return CliColorRender(str, 37, 0, modifier...)
}

// CliWhite 白色
func CliWhite(str string, modifier ...interface{}) string {
	return CliColorRender(str, 37, 1, modifier...)
}

// CliBlue 蓝色
func CliBlue(str string, modifier ...interface{}) string {
	return CliColorRender(str, 34, 0, modifier...)
}

// CliLightBlue 淡蓝
func CliLightBlue(str string, modifier ...interface{}) string {
	return CliColorRender(str, 34, 1, modifier...)
}

// CliPurple 紫色
func CliPurple(str string, modifier ...interface{}) string {
	return CliColorRender(str, 35, 0, modifier...)
}

// CliLightPurple 淡紫色
func CliLightPurple(str string, modifier ...interface{}) string {
	return CliColorRender(str, 35, 1, modifier...)
}

// CliBrown 棕色
func CliBrown(str string, modifier ...interface{}) string {
	return CliColorRender(str, 33, 0, modifier...)
}